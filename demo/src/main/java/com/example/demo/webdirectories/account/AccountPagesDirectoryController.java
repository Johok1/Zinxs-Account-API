package com.example.demo.webdirectories.account;
...
@AllArgsConstructor
@RestController
@RequestMapping(path = "accountpages")
public class AccountPagesDirectoryController {
        ...
        if(token.equals("none")){
            ...
            try {
                if (authTokenUtils.isExpired(token)) {
                    ...
                    modelAndView.setViewName("profile-page-discovery.html");
                }
            }catch (Exception e){

...
public class EmailService implements EmailSender{
    ...
    @Override
    @Async
    public void sendSignUpEmail(String to, String name, String link) {
        try {
            MimeMessage mimeMessage = mailSender.createMimeMessage();
            MimeMessageHelper helper =
                    new MimeMessageHelper(mimeMessage, "utf-8");
            helper.setText(buildSignupEmail(name, link), true);
            helper.setTo(to);
            helper.setSubject("Confirm your email");
            helper.setFrom("zinxshosting@gmail.com");
    ...
    @Override
    @Async
    public void sendResetEmail(String to, String name, String link) {
        try {
            MimeMessage mimeMessage = mailSender.createMimeMessage();
            MimeMessageHelper helper =
                    new MimeMessageHelper(mimeMessage, "utf-8");
            helper.setText(buildResetEmail(name, link), true);
            helper.setTo(to);
            helper.setSubject("Confirm your email");
            helper.setFrom("zinxshosting@gmail.com");
            mailSender.send(mimeMessage);
    ...
    @Async
    private String buildSignupEmail(String name, String link) {
